...
const Navbar = ({setShowLogin}) => {
  ...
  return (
    ...
    <div className='navbarf'>
      <div className=''>
      <Link to='/food-order'> <img src={""} alt="" className=" w-20 top-0 pb-2 pl-24 h-30 text-3xl text-white font-bold" /></Link>
      <a href='#footer' onClick={()=> setMenu("contact-us")} className="text-white text-3xl font-bold pl-5">ASHI</a>
